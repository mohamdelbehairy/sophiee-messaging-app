          ...
          itemBuilder: (BuildContext context) {
            return [
              ...
              if (message.messageText.isNotEmpty)
                customPopMenuItemMethod(
                    ...
                    onTap: () async {
                      context
                          .read<CopyTextCubit>()
                          .copyText(text: message.messageText);
                    }),
              customPopMenuItemMethod(
                  name: 'Forward',
                  size: size,
                    ...
                    onTap: () async {
                      if (groupModel != null) {
                        if (message.highlightMessage!
                          ...
                          await highLightMessagesCubit!
                              .removeHightLightMessages(
                                  groupID: groupModel!.groupID,
              ...
              if (user != null)
                customPopMenuItemMethod(
                    name:
                        message.highlightChatMessage! ? 'Remove' : 'Favourite',
                    size: size,
                      ...
                      deleteMessageShowDialog(
                          ...
                          onPressed: () async {
                            ...
                            if (deleteGroupMessagesCubit != null &&
                                groupModel != null) {
                              await deleteGroupMessagesCubit!
                                  .deleteGroupMessage(
                                      groupID: groupModel!.groupID,
                                      messageModel: message);
                            }
