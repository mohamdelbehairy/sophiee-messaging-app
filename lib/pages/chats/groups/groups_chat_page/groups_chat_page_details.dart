...
import '../../../../widgets/all_chats_page/groups_page/groups_chat_page/groups_chat_page_body_component.dart';

class GroupsChatPageDetails extends StatelessWidget {
  const GroupsChatPageDetails(
      {super.key,
              ...
              decoration: userData.chatbackgroundImage != null
                  ? BoxDecoration(
                      image: DecorationImage(
                          ...
                          fit: BoxFit.cover))
                  : null,
              child: GroupsChatPageBodyComponent(
